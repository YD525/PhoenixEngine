...
namespace PhoenixEngine.Language
{
    internal static class CzechHelper
    {
        ...
        private static readonly Regex CzechKeywordRegex = new Regex(
            @"\b(já|ty|on|ona|ono|my|vy|oni|ony|ona|je|jsem|jsi|jsou|byl|byla|bylo|byli|být|mám|máš|má|máme|máte|mají|mít|co|kdo|jak|kde|kdy|proč|ten|ta|to|ti|ty|ta|toto|tento|tato|jeden|jedna|jedno|ale|nebo|a|i|že|když|protože|pokud|jak|jako|také|jen|už|ještě|více|méně|než|tak|zde|tam|tady|pak|dnes|teď|již|velmi|se|si|ho|mu|jej|ji|nás|vás|nich|ve|na|do|z|ze|od|pro|při|po|před|za|nad|pod|mezi|bez|přes|ke|ku|o|u)\b",
            RegexOptions.Compiled | RegexOptions.IgnoreCase
        );
